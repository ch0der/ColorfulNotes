...
class SaturdayList extends StatefulWidget {
  final String heroDay;

  SaturdayList({this.heroDay});

  final String color = 'color6';
...
class _ListViewerState extends State<SaturdayList> {
  Color _thisColor;
  ...
  Widget viewerTest(SaturdayBloc bloc) {
