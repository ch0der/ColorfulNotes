First flutter app and first time learning mobile dev.  Coding was ineffecient as to be expected for a first app but it showcases some cool Flutter animation + UI features and SQLLite.
